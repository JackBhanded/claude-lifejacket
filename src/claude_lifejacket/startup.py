"""Register / unregister Lifejacket under the per-user Run key.

We use HKCU so no admin elevation is needed. The Run-at-startup feature is
only offered when Lifejacket is running as a frozen ``.exe`` (the dev-mode
